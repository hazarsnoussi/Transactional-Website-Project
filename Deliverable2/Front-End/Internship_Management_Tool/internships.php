...
<html lang="en">
  ...
  Here is a list of the availbale internship offers added to the department of <?php echo $rowi['department'];?>
  </p>  
  ...
  WHERE field = '$field' AND company.isActive = 1 AND internshipoffer.isActive=1 
          ...
          <?php while ($roww = mysqli_fetch_assoc($res)){?>
            <tr>
              <td><?php echo $roww['internshipTitle'];?></td>
               <?php  $internshipid = $roww['internshipID'];
              // echo "$internshipid; ?> 
