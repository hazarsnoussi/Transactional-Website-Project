		...
		<form name = "f" action= "#" method="POST">
				<table  style="border:1; width:50%;height:90%;">
					<tr>
						...
						<td><input type="text" size="50" name="firstName" value= <?php echo $row['firstName']; ?> disabled></td>
					</tr>
					<tr>
						<td><label >Last Name:</label></td>
						<td><input type="text" size="50" name="lastName" value= <?php echo $row['lastName']; ?> disabled ></td>
					</tr>
					<tr>
						<td><label >Date of birth:</label></td>
						<td><input type="text" size="50" name="dob" value= <?php echo $row['dateOfBirth']; ?> disabled ></td>
					</tr>
					<tr>
						<td><label>E-mail:</label></td>
						<td><input type="email" size="50" name="email" value= <?php echo $row['email']; ?> disabled></td>
					</tr>
					<tr>
						<td><label>Password:</label></td>
						<td><input type="text" size="50" name="password" value= <?php echo $row['password'];?> disabled></td>
					</tr>
					<tr>
						<td><label>Phone Number:</label></td>
						<td><input type="tel" size="50" name="phone" value= <?php echo $row['phoneNumber']; ?> disabled></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" size="50" name="rscore" value= <?php echo $row['RScore']; ?> disabled ></td>
					</tr>
					<tr>
						...
						<td> 
							...
							<input type="text" size="50"name="programTitle" value= <?php echo $row1['programTitle']; ?> disabled>	
						</td>
					</tr>				
					<tr>
            ...
            <tr>
              <td><h3>Portfolio:</h3></td>
                ...
                while ($row = mysqli_fetch_assoc($result)){
                  ?>
                  <tr>
                  <td><a href="uploads/documents/<?php echo $uid.$row['type'].".".$row['extension']?>" target="_blank" "="" ><?php echo $row['type']?></a></td>
